...
log using "${LOG_PATH}prepCF_HK.txt", text replace


use "M:\_FDZ\RWI-GEO\RWI-GEO-RED\daten\SUF\v3\HK_SUF_ohneText.dta", clear

drop  mietekalt mietewarm nebenkosten anzahletagen etage wohngeld aufzug balkon betreut heizkosten_in_wm_enthalten kategorie_Wohnung erg_amd gid2015 kid2015 lieferung r1_id blid kid_updated gid_updated uniqueID_gen ags plz dupID_gen
 ...
 *Baujahr
 tab baujahr
	...
	save "M:\_FDZ\RWI-GEO\RWI-GEO-RED\daten\PUF\v3\PUF_HK_zwischen.dta", replace
	
	
	*****************
	*Zeitreihe nur grösste Städte
	use "M:\_FDZ\RWI-GEO\RWI-GEO-RED\daten\PUF\v3\PUF_HK_zwischen.dta", clear	
	drop if ajahr==2020
...
compress
save "M:\_FDZ\RWI-GEO\RWI-GEO-RED\daten\PUF\v3\PUF_HK_cities.dta", replace
...
compress
save "M:\_FDZ\RWI-GEO\RWI-GEO-RED\daten\PUF\v3\PUF_HK_2019.dta", replace
